function DMG_buff_only_hit(argument0, argument1, argument2, argument3) {
	var D = argument0
	var buff_name = argument1
	var sturn_time = argument2
	var buff_time1 = argument3
	var send_exp = D * 1.3
					...
					if (sturn <= 0 and immune == false) {
						if (shild == true and shild_time < 1) {
							...
							if (counter < 0) {
								...
								if (just_time > 0) {
									if (obj_id.hat_frame < level) send_exp *= 1.8;
									buffer_seek(testing.buff_chat, buffer_seek_start, 0);
...
function DMG_buff(argument0, argument1, argument2, argument3) {
	var D = argument0
	var buff_name = argument1
	var sturn_time = argument2
	var buff_time1 = argument3
