...
draw_sprite_ext(face,0,x,y,1,1,YA,color,image_alpha); 

draw_sprite_ext(hat,0,hat_x,hat_y,1 * big_val, big_val,YA,color,image_alpha);//모자

draw_set_color(c_black);
draw_text_bold(x - 44, y + 32, "■ 탈모레인저 민트 ■");

if (cid_id.hat != spr_ehat4 and cid_id.hat != spr_level5_hat10) {
	switch (cid_id.team) {
		case 0 : 
			draw_set_color(c_red);
			draw_text(x - 44, y + 32, "■ 탈모레인저 민트 ■")
		break;
		default : 
