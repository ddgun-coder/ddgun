...
/// @DnDVersion : 1
/// @DnDHash : 79FCAB81
/// @DnDArgument : "code" "x = cid_id.x + lengthdir_x(35 * cid_id.big_val,cid_id.YA-90)$(13_10)y = cid_id.y + lengthdir_y(35 * cid_id.big_val,cid_id.YA-90)$(13_10)draw_self();$(13_10)image_angle = cid_id.YA;$(13_10)image_xscale = cid_id.big_val * 0.5;$(13_10)image_yscale = cid_id.big_val * 0.5;$(13_10)if(cid_id.cancle_able == false or cid_id.sturn > 0) {$(13_10)	instance_destroy();$(13_10)}"
