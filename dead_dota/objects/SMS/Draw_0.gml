...
var cur_xview = camera_get_view_x(view_camera[0]) + global.window_width / 2 - (1024 / 2 - xstart);
var cur_yview = camera_get_view_y(view_camera[0]) + global.window_height - (768 - ystart);
