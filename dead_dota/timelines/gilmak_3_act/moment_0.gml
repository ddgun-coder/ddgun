...
/// @DnDVersion : 1
/// @DnDHash : 40033059
/// @DnDArgument : "code" "arm_all_normal()$(13_10)a_cooltime = 120;$(13_10)view_visible[0] = false;$(13_10)view_visible[1] = true;$(13_10)view_where = 1;$(13_10)obj_telescope_view.tele = true;$(13_10)obj_telescope_view.go_pixel = 550;$(13_10)obj_telescope_view.go_to = 550;$(13_10)arm_type = "attack"$(13_10)arm_movement(3, -3, 10, 10);$(13_10)terror_charge = 0;$(13_10)cancle_able = true;$(13_10)server77_equal("cancle_able", cancle_able, buffer_bool);$(13_10)server77_equal("terror_charge", 0, buffer_u8)$(13_10)server78_create_instace(gilmak_skill3, x, y);"
arm_all_normal()
a_cooltime = 120;
...
server78_create_instace(gilmak_skill3, x, y);